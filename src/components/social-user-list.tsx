          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {users.map((user) => (
              <Link
                ...
                className="rounded-[2rem] border border-[var(--border)] bg-[var(--surface)] p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-[rgba(139,92,246,0.65)] hover:shadow-lg"
              >
